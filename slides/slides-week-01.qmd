...
::: {.notes}
https://rin3spring2026.rfortherestofus.com/slides/slides-week-01.html
:::
...
participants <-
  read_sheet(
    ...
    sheet = "Spring 2026 Participants"
  ) |>
  clean_names()
...
[![](assets/course-materials.png)](https://rfortherestofus.com/courses/r-in-3-months-spring-2026)

::: {.notes}
- First to see Positron materials
...
[![](assets/project-assignment-example.png)](https://rfortherestofus.com/courses/r-in-3-months-spring-2026/lessons/spring-2026-week-2-project-assignment)
