...
1. Copy the code from [this Quarto document](https://raw.githubusercontent.com/rfortherestofus/rin3-spring-2026/refs/heads/main/misc/no-render.qmd). Figure out why it won't render and change it so that it will!

1. Copy the code from [this second Quarto document](https://raw.githubusercontent.com/rfortherestofus/rin3-spring-2026/refs/heads/main/misc/guess-what.qmd). There are a series of questions in it. Tackle them one by one, making changes to the document as you do so.
